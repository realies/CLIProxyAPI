...
func TestClaudeCloakIsDeterministicFromRawClientHistory(t *testing.T) {
	...
	cloak := func(payload []byte, strict bool) []byte {
		payload = checkSystemInstructionsWithSigningModeAt(payload, strict, true, "2.1.258", "cli", "", now, false, "", "")
...
func TestClaudeBoundedRebuildCanonicalizesRetainedSystemString(t *testing.T) {
	...
	turn1 = checkSystemInstructionsWithSigningModeAt(turn1, false, true, "2.1.258", "cli", "", time.Date(2026, 9, 3, 12, 0, 0, 0, time.UTC), false, "", "")
